...
import WBCommissions from './pages/WBCommissions'
import PromotionAudit from './pages/PromotionAudit'
    ...
    <BrowserRouter>
      <Routes>
        <Route path="/" element={<Layout />}>
          ...
          <Route path="commissions" element={<WBCommissions />} />
          <Route path="promotion-audit" element={<PromotionAudit />} />
