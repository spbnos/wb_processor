...
import { Activity, FileUp, GitBranch, Brain, BarChart2, Settings, BookOpen, Grid, Percent, Megaphone } from 'lucide-react'
...
export default function Layout() {
  ...
  const NAV = [
    ...
    { to: '/commissions', icon: Percent,     label: 'Удержания WB',    badge: null },
    { to: '/promotion-audit', icon: Megaphone, label: 'Аудит РК',       badge: null },
  ]
